...
INPUT_DIR=/database2/taewoo/Code/data_past/6/frames
MASK_DIR="/database2/taewoo/Code/data_past/6/object_mask_2"
OUTDIR="./Gaussian_output/scene_6"
VISDIR="./vis_scene_6"


##### Warping #####
CAM_PARAM_PATH="/database2/taewoo/Code/data_past/6/cam_params.pkl"
INTRINSIC_PATH="/database2/taewoo/Code/data_past/6/sparse/cameras.txt"
DEPTH_DIR="/database2/taewoo/Code/data_past/6/depths"
